...
class Hot extends Component {
        ...
        return (
            <View style={styles.hotItemRcmd}>
                ...
                <View style={styles.rcmdBody}>
                    <FlatList
                        // onTouchStart={this._setTabLocked}
                        // onTouchEnd={this._setTabUnLocked}
                        data={item.item}
    ...
    //点击横向列表时锁住tabbar
    _setTabLocked = () => {
        console.warn('_setTabLocked');
        this.props._lockSlide()
    }
    //手势松开时解锁tabbar
    _setTabUnLocked = () => {
        console.warn('_setTabUnLocked');
        this.props._openSlide()
    }

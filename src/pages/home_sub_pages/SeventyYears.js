...
import { View, Text, Image, Dimensions, StyleSheet, ScrollView, ImageBackground, TouchableHighlight } from 'react-native'
    ...
    render() {
        return (
            <ScrollView style={{ height: "100%" }}>
                <View>
                    <Image source={{ uri: 'http://i0.hdslb.com/bfs/archive/2e92d79c8a2a5a87f0d91ab1d493d09f5c1b2ec6.jpg' }} style={{ width: "100%", height: 150 }}></Image>
                </View>
                            ...
                            >
                                <View >
                                    ...
                                    <View style={styles.borderpic}>
                                        <View >
                                            <Text style={{ fontSize: 14, paddingLeft: '4%', paddingRight: "5%" }}>{item.tit}</Text>
                                        </View>
                                        <View>
...

                {
                    this.state.pdata.map((item, index) => {
                        return (
                            <View style={{ marginLeft: '2%', marginRight: '2%', marginBottom: 8 }}>
                                <View>
